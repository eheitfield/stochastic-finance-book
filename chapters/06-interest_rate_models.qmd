...
## Vasicek's model and the valuation of real bonds
...
![Yield curves implied by the Vasicek model given different initial short rates ($r_0$).](../figures/vasicek_term_structure.svg){#fig-Vasicek_term_structure}
...
$$
\begin{align*}
dP =& \pd{B}{t}\,dt + \pd{P}{r}\,dr_t + \frac12\pdd{P}{r}\,(dr)^2 \\
...
![10-year Treasury note yield annual average yield versus price volatilty, 1961 to 2025.](../figures/bond_vol.svg){#fig-bond_vol}
