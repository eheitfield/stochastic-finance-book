...
class StochasticProcess(ABC):
    """Abstract base class for a simulatable stochastic process.

    Subclasses must implement :meth:`generate_paths`, which produces a
    :class:`~SamplePaths` object containing one or more sample paths
    of the process.

    The canonical signature is::

        generate_paths(self, n_paths, n_inc, max_T, seed) -> SamplePaths
    ...
    def generate_paths(
        ...
        -------
        SamplePaths
            Container holding the simulated paths and time vector.
        """
        pass
